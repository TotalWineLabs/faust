...
__all__ = ['ForeignKeyJoinProcessor']


class ForeignKeyJoinProcessor(Service, ForeignKeyJoinT):
    """Manages the full FK join lifecycle using the subscription/response
